    ...
    <div class="container-fluid d-flex align-items-center font-weight-bold custom ">
      ...
      <nav class="nav-menu d-none d-lg-block">
        ...
        <ul>
          ...
          <li><a href="leaveapp_table.php">LEAVE APP</a></li>
          <li><a href="activities_table.php">ACTIVITIES</a></li>
           ...
           <li class="drop-down"><a href="">ASSESSMENT</a>
            <ul>
                ...
                <li><a href="document_table.php">COURSE MATERIAL (NOTES,ASSIGNMENT)</a></li>
          ...
          <li class="drop-down"><a href="">COMMUNICATION</a>
            <ul>
                ...
                <li><a href="userlist.php">CHAT</a></li>
                 <li><a href="query_table.php">QUERY</a></li>
            </ul>
          </li>
          ...
          $tmsg=$df->getcount("select count(*) from chatcount where regidto='$regid'");  
          ?>
          
           <li class="drop-down"><a href=""><i class="fas fa-envelope"></i>
            <span class="badge badge-danger" style="border-radius: 50%; position: relative; background: red; top: -10px;left: -10px;"><?php echo $tmsg; ?></span>
           </a>
           <ul>
           <?php
                 $query="select distinct c.regidfrom,username from chat c , chatcount t ,register r where c.regidto='$regid' AND c.regidto=t.regid AND r.regid=c.regidfrom";
                  $tb=$df->getTable($query);
                  if (mysqli_num_rows($tb)>0) {
                   
                      while($rw=mysqli_fetch_array($tb))
                      {
                          echo '<a class="dropdown-item text-primary font-weight-bold">'.$rw['regidfrom'].'  :  '.$rw['username'].'</a>';
                      }
                  }
                  else
                  {
                          echo '<a class="dropdown-item text-danger font-weight-bold">Sorry ! No message..</a>';
                  }
            ?>
            </ul>
          </li>
