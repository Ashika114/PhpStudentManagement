         ...
         <div class="col-md-12">
          ...
          <div class="panel panel-default">
           ...
           echo("<table class='table table-bordered table-striped' id='tabsearch'>");
            ...
            echo("<th>SUBJECT ID</th><th>SUBJECT NAME</th><th>SUBJECT TYPE</th><th>SEM</th><th>COURSE NAME</th><th>DELETE</th><th>UPDATE</th>");
          echo("</tr></thead>");
          $query="select subid,subname,subtype,sem,coursename from course c,subject s where c.courseid=s.courseid";
